...
if __name__ == '__main__':
    ...
    # get the torchscript model
    traced_script_module = torch.jit.trace(model, dst_tensor[0:1])
    # traced_script_module.save("torch_script_model.pt")
    loaded_model = torch.jit.load("torch_script_model.pt")
    with torch.no_grad():
        output_script = loaded_model(dst_tensor)
